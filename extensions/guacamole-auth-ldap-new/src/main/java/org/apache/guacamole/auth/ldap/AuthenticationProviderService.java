...
public class AuthenticationProviderService {
    ...
    public LDAPAuthenticatedUser authenticateUser(Credentials credentials)
        ...
        try {
            ...
            logger.trace("authenticateUser: effectiveGroups: \"{}\", authenticatedUser: \"{}\"", effectiveGroups, authenticatedUser.getIdentifier());
    ...
    public LDAPUserContext getUserContext(AuthenticatedUser authenticatedUser)
        ...
        if (authenticatedUser instanceof LDAPAuthenticatedUser) {
        	logger.trace("getUserContext: authenticatedUser(\"{}\") is instanceof LDAPAuthenticatedUser", authenticatedUser.getIdentifier());
        	...
        	logger.trace("getUserContext: authenticatedUser(\"{}\") !instanceof LDAPAuthenticatedUser", authenticatedUser.getIdentifier());
        }
        return null;
