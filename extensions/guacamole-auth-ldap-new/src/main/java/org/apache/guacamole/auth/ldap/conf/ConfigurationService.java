...
public class ConfigurationService {
    ...
    /**
     * Returns the id of the LDAP matchingrule used to match
     * members in a group, or null by default.
     * 
     * @return
     *     The id of the LDAP matchingrule to match
     *     members in a group.
     * 
     * @throws GuacamoleException
     *     If guacamole.properties connect be parsed.
     */
    public String getMemberMatchingrule() throws GuacamoleException {
        return environment.getProperty(
            LDAPGuacamoleProperties.LDAP_MEMBER_MATCHINGRULE,
            null
        );
    }
