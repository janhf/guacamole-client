...
public class LDAPGuacamoleProperties {
    ...
    /**
     * LDAP matching rule for matching ldap-member-attribute with userid or userdn in the LDAP directory.
     */
    public static final StringGuacamoleProperty LDAP_MEMBER_MATCHINGRULE =
            new StringGuacamoleProperty() {
      
        @Override
        public String getName() { return "ldap-member-matchingrule"; }
